  ...
  return (
    <div className="flex min-h-screen w-full bg-white dark:bg-slate-950">
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-slate-900 lg:block">
        ...
        <div className="absolute -left-1/4 -top-1/4 h-[800px] w-[800px] rounded-full bg-fuchsia-500/20 blur-[120px]" />
        <div className="absolute -bottom-1/4 -right-1/4 h-[600px] w-[600px] rounded-full bg-indigo-500/30 blur-[100px]" />
