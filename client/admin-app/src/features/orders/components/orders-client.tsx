  ...
  return (
    <div className="font-poppins min-w-0 overflow-x-hidden">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-500">All flash deal orders across the platform.</p>
      </div>
                  ...
                  <td className="px-4 py-4">
                    <div className="flex justify-center">
                      <button
                        ...
                        className="hover:border-primary/30 hover:bg-primary/10 hover:text-primary flex h-10 w-10 items-center justify-center rounded-lg border border-gray-100 bg-white text-gray-600 shadow-sm transition-all"
                      >
                        <Eye size={15} />
                      </button>
                    </div>
      ...
      >
        {viewingOrder && (
          <div className="space-y-6">
            ...
            {/* Metrics grid */}
            <div className="grid grid-cols-2 gap-x-8 gap-y-6 rounded-2xl border border-gray-100 bg-gray-50/50 p-5">
              <div>
              ...
              <div>
                ...
                <p className="text-primary mt-1 text-sm font-bold">{viewingOrder.value}</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-gray-900">
                  Credit Card / {viewingOrder.payment}
                </p>
              </div>
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider text-gray-400">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 rounded-xl border border-gray-100 p-3 shadow-sm">
                  <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg bg-gray-100">
                    <img
                      src={viewingOrder.productImage as string}
                      alt={viewingOrder.products as string}
              ...
              <div>
                ...
                <div className="relative space-y-5 pl-4">
                  <div className="left-1.75 absolute bottom-2 top-2 w-0.5 bg-gray-100" />

                  {(
                    viewingOrder.timeline as { step: string; date: string; completed: boolean }[]
                  )?.map((step, idx: number) => (
                    <div key={idx} className="relative flex items-start gap-3">
                      <div
                        className={`relative z-10 flex h-4 w-4 shrink-0 items-center justify-center rounded-full ${step.completed ? "bg-emerald-500" : "border-2 border-white bg-gray-200"}`}
                      >
                        {step.completed && <CheckCircle2 size={12} className="text-white" />}
                      </div>
                      <div className="-mt-1 min-w-0 flex-1">
                        <p className="text-sm font-medium text-gray-900">{step.step}</p>
                        {step.date && <p className="mt-0.5 text-xs text-gray-500">{step.date}</p>}
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="rounded-xl border border-gray-100 p-4">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  type="button"
                  className="shrink-0 rounded-xl bg-gray-900 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:bg-gray-800"
                >
                  Update status
                </button>
              </div>
