            ...
            <div className="flex items-start justify-between gap-5">
              <div className="flex items-center gap-5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex flex-col gap-1.5 sm:flex-row sm:items-center sm:gap-4 text-gray-500">
                    <p className="text-sm font-medium">DOB: {viewingCustomer.dob || "N/A"}</p>
                    <p className="hidden text-gray-300 sm:block">•</p>
                    <p className="text-sm font-medium">Gender: {viewingCustomer.gender || "N/A"}</p>
                  </div>
