...
import { NotificationDropdown } from '@/features/account/components/notification-dropdown';
import { ProfileDropdown } from '@/features/account/components/profile-dropdown';
