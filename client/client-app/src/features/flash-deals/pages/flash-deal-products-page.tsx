...
export function FlashDealProductsPage() {
  const id = "1"; // Fallback as this route doesn't have an ID parameter
    ...
    <div className="font-poppins relative mx-auto w-full max-w-[1920px] px-4 py-6 md:px-8 xl:px-10">
      ...
      <div className="mb-8 flex items-center justify-between">
        <nav className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <Link to="/flash-deals" className="hover:text-black">
            Flash Deals
          </Link>
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 rounded-xl border border-gray-200 px-4 py-2 text-sm font-semibold hover:bg-gray-50">
            <Heart size={18} />
            Wishlist
          </button>
      ...
      <section className="mb-10 grid grid-cols-1 gap-8 xl:grid-cols-12">
        {/* IMAGE */}
        ...
        <div className="flex flex-col xl:col-span-4">
          <span className="text-primary mb-4 w-fit rounded-md bg-purple-50 px-3 py-1 text-xs font-bold">
            {product.category}
          </span>
        ...
        <div className="flex flex-col gap-5 xl:col-span-3">
          ...
          <div className="rounded-[1.25rem] border border-purple-100 bg-purple-50 p-5">
            ...
            <div className="mb-5 rounded-xl bg-white p-4">
              ...
              <h2 className="text-3xl font-extrabold">₹1</h2>
            </div>

            <button className="bg-primary w-full rounded-xl py-3 text-sm font-bold text-white hover:opacity-90">
              Register for ₹1
            </button>
          </div>
          ...
          <div className="rounded-[1.25rem] border bg-white p-5">
            <h3 className="mb-5 font-bold text-gray-900">Deal Highlights</h3>
          ...
          {/* Delivery */}
          <div className="rounded-[1.25rem] border bg-white p-5">
            <h3 className="mb-4 font-bold">Delivery Details</h3>
      ...
      <section className="mb-10 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border bg-white p-6">
          <h2 className="mb-4 font-bold">About Product</h2>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t bg-white shadow-lg">
        <div className="mx-auto flex max-w-[1920px] items-center justify-between gap-5 px-4 py-4 md:px-10">
          <div>
            <h3 className="font-bold">Register now for ₹1</h3>
            <p className="text-sm text-gray-500">Get early access to this deal</p>
          </div>
          <div className="flex gap-3">
            <button className="rounded-xl border px-5 py-3">
              <Heart size={18} />
            </button>
            <button className="bg-primary rounded-xl px-8 py-3 font-bold text-white">
              Register ₹1
            </button>
          </div>
        </div>
