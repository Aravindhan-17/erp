...
import ProductTabs from "@/features/flash-deals/products/components/product-tabs";
import {
  Heart,
  Share2,
  ShieldCheck,
...
export function FlashDealProductDetailPage() {
    ...
    <div className="font-poppins relative mx-auto w-full max-w-[1920px] px-4 py-6 md:px-8 xl:px-10">
      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <nav className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <Link to="/flash-deals" className="transition-colors hover:text-black">
            Flash Deals
          </Link>
          <ChevronRight size={14} />
