...
import { FlashCard } from '../../flash-deals/components/flash-card';
  ...
  return (
    <section className="relative mx-auto w-full max-w-[1920px] px-4 md:px-8 xl:px-10">
      <div className="mx-auto w-full">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4">
          {deals.map((deal) => (
