    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="flex flex-col items-center rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
          ...
          <Link to="/orders" className="text-secondary mt-4 text-sm font-medium hover:underline">
            View Orders &rarr;
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
          ...
          <Link to="/wallet" className="text-secondary mt-4 text-sm font-medium hover:underline">
            Manage Wallet &rarr;
          </Link>
        </div>
