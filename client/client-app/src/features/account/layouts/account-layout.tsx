        ...
        <aside className="w-full shrink-0 lg:w-64">
          <nav className="flex flex-col gap-2 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-gray-100">
            <div className="mb-6 flex items-center gap-3 px-2">
              ...
              <div>
                <h2 className="text-sm font-bold text-gray-900">{user?.firstName} {user?.lastName}</h2>
            ...
            <button 
              ...
              className="flex items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-medium text-red-600 transition-colors hover:bg-red-50"
            >
