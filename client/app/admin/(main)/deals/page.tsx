  ...
  return (
    <div className="space-y-8 font-poppins">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-gray-900">Flash Deal Engine</h1>
          <p className="text-gray-500 text-sm mt-1">Schedule and monitor high-traffic flash sales events.</p>
        </div>
