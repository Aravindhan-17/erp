...
export function DealTerms() {
  return (
    <section className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3">
        <h2 className="text-lg font-bold text-gray-800">Terms shown to shoppers</h2>
      ...
      <textarea
        ...
        rows={3}
        className="focus:border-primary/50 focus:ring-primary/20 w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-xs font-semibold text-gray-700 outline-none transition focus:ring-2"
      />
    </section>
  );
}
