    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <button
          ...
          className="hover:border-secondary hover:text-secondary hover:bg-secondary/5 flex h-full min-h-70 flex-col items-center justify-center gap-4 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 p-6 text-gray-500 transition-all"
        >
