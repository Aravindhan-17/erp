    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      <div>
        ...
        <input
          ...
          min={1000}
          max={50000}
          className="h-[10px] w-full appearance-none bg-transparent pt-[10px] opacity-100 [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:bg-[#F3380B] [&::-moz-range-track]:h-0 [&::-moz-range-track]:w-full [&::-moz-range-track]:border-[3px] [&::-moz-range-track]:border-solid [&::-moz-range-track]:border-[#F3380B] [&::-webkit-slider-runnable-track]:h-0 [&::-webkit-slider-runnable-track]:w-full [&::-webkit-slider-runnable-track]:border-[3px] [&::-webkit-slider-runnable-track]:border-solid [&::-webkit-slider-runnable-track]:border-[#F3380B] [&::-webkit-slider-thumb]:-mt-[6px] [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#F3380B]"
        />
