  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
      ...
      <div className="flex overflow-x-auto border-b border-gray-200">
        ...
        {tabs.map((item) => {
          const value = item.startsWith("Reviews")
            ? "Reviews"
            : item;
          ...
          return (
            <button
              ...
              className={`whitespace-nowrap px-6 py-4 text-sm font-medium border-b-2 transition-all
              ${
                tab === value
        ...
        {tab === "What's in the Box" && (
          ...
          <ul className="ml-5 list-disc space-y-3 text-gray-600">
            ...
            product.boxItems.length > 0 ? (
              ...
              product.boxItems.map((item: string) => (
