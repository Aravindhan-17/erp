  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="text-foreground/75 mb-8">
        Welcome to FlashERP! Here is everything you need to know about reserving and buying products during our flash deals.
      </p>
      
      <div className="space-y-6">
        <div className="bg-background rounded-2xl p-6 border border-border shadow-sm">
          <h2 className="text-xl font-bold mb-2">1. Register for Deals</h2>
        ...
        <div className="bg-background rounded-2xl p-6 border border-border shadow-sm">
          <h2 className="text-xl font-bold mb-2">2. Reserve Your Item</h2>
          <p className="text-foreground/75">
        ...
        <div className="bg-background rounded-2xl p-6 border border-border shadow-sm">
          <h2 className="text-xl font-bold mb-2">3. Checkout Securely</h2>
          <p className="text-foreground/75">
