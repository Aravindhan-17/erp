    ...
    <form className="flex w-full flex-col items-center gap-4 lg:gap-6" onSubmit={(e) => e.preventDefault()}>
      ...
      <div className="max-w-192.5 flex w-full flex-col gap-4 lg:gap-5">
        <div className="grid grid-cols-1 gap-4 lg:gap-5 sm:grid-cols-2">
          ...
          <div className="flex w-full flex-col gap-2 lg:gap-2.5">
            ...
            <div className="h-12 lg:h-14 2xl:h-17.5 relative w-full">
              ...
              />
              <Eye className="absolute right-4 top-1/2 h-5 w-5 lg:h-6 lg:w-6 2xl:h-8 2xl:w-8 -translate-y-1/2 text-black/25" />
            </div>
          </div>
        ...
        <div className="mt-auto flex w-full items-start gap-2.5 pt-2 sm:items-center">
          ...
          >
            <span className="flex items-center font-['Poppins'] text-sm sm:text-base 2xl:text-[20px] font-semibold leading-tight text-black">
              I agree to the
            </span>
            <Link
              href="#"
              className="text-primary flex items-center font-['Poppins'] text-sm sm:text-base 2xl:text-[20px] font-semibold leading-tight underline hover:text-primary/90 transition-colors"
            >
              Terms & Conditions
            </Link>
            <span className="flex items-center font-['Poppins'] text-sm sm:text-base 2xl:text-[20px] font-semibold leading-tight text-black">
